<?php
    ...
    $data = new ClasseController();
    if (isset($_POST['find'])) {
        $af = $data->findClasse();
    } else {
        $af = $data->getAllClasse();
    }
            ...
            <div class="card">
                <div class="card-body bg-light">
                    <div class="d-flex flex-row justify-content-between">
                        <div class="">    
                            <a href="<?php echo BASE_URL ?>classesAdd" class="badge h-75 fs-5 text-center badge-success bg-primary mb-3"> <i class="fa fa-plus text-light"></i> </a>
                        </div>
